import 'package:e_delivery_mobile/deliveryPerson/screens/order/api/delivery_order_api.dart';
...
class DeliveryOrderDetailsPage extends StatefulWidget {
  ...
  const DeliveryOrderDetailsPage({Key? key, required this.orderId})
      : super(key: key);
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                Navigator.of(context).pop();
                await _orderService.updateOrderState(order!.id, 3);

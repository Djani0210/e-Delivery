...
class EmployeeUpdateProfilePage extends StatefulWidget {
  final Function onProfileUpdated;
  const EmployeeUpdateProfilePage({Key? key, required this.onProfileUpdated})
      : super(key: key);
  @override
  _UpdateProfilePageState createState() => _UpdateProfilePageState();
}

class _UpdateProfilePageState extends State<EmployeeUpdateProfilePage> {
  ...
  int? cityId;
  DeliveryPersonGetDTO? _userDataViewModel;

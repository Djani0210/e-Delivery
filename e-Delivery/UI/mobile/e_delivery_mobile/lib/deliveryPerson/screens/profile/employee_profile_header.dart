...
class EmployeeProfileHeader extends StatefulWidget {
  final DeliveryPersonGetDTO userDataViewModel;

  EmployeeProfileHeader({Key? key, required this.userDataViewModel})
      : super(key: key);
...
class _ProfileHeaderState extends State<EmployeeProfileHeader> {
  @override
...
class EmployeeUserData extends StatelessWidget {
  final DeliveryPersonGetDTO userDataViewModel;
